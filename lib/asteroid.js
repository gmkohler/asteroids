(function () {
  ...
  Asteroid.prototype.collideWith = function (obj2) {
    if (obj2 instanceof window.Asteroids.Ship && obj2.isAlive) {
      this.breakUp(obj2);
      obj2.explode();
  ...
  Asteroid.prototype.breakUp = function (collidingObj) {
    ...
    // Determine initial impact
      ...
      var ast1 = new Asteroid(this.game, this.pos, this.rank + 1, vels[0]);
      var ast2 = new Asteroid(this.game, this.pos, this.rank + 1, vels[1]);
